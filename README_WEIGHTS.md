...
The Zen weight file consists of two main components: **Main Model Weights** and **MTP Modules**.
...
Zen natively supports FP8 weight format with 128x128 block scaling.
